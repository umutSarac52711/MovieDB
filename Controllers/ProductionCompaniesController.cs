...
public class ProductionCompaniesController : Controller // Renamed from ActorsController
{
    private readonly MovieDbContext dbContext;
    public ProductionCompaniesController(MovieDbContext dbContext) 
    {
    ...
    {
        return View(new ProductionCompanyViewModel()); // Pass a new view model
    }

    [HttpPost]
    public async Task<IActionResult> Add(ProductionCompanyViewModel model) 
    {
        if (ModelState.IsValid)
        {
            ...
            await dbContext.ProductionCompanies.AddAsync(productionCompany); 
    ...
    {
        var companies = await dbContext.ProductionCompanies.ToListAsync(); 
    ...
    {
        var company = await dbContext.ProductionCompanies
        ...
        var viewModel = new ProductionCompanyViewModel 
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Edit(ProductionCompanyViewModel model) 
    {
        if (ModelState.IsValid)
        {
            var company = await dbContext.ProductionCompanies
    ...
    public async Task<IActionResult> DeleteConfirmed(int id)
    {
        ...
        dbContext.ProductionCompanies.Remove(company); 
